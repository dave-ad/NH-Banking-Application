...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.changeEntry2.place(x=166, y=159, height=27, width=204
                                , bordermode='ignore')
        ...
        self.changeButton1 = tk.Button(self.changeLabelframe2,
                                       command=lambda: self.reset_thread(None))
        self.changeButton1.place(x=156, y=240, height=34, width=150
                                 , bordermode='ignore')
        ...
        self.changenameEntry2.place(x=166, y=159, height=27, width=204
                                    , bordermode='ignore')
        ...
        self.changenameButton1.place(x=156, y=240, height=34, width=150
                                     , bordermode='ignore')
        ...
        # self.desacct_entry = tk.Entry(self.exchange_frame)
        # self.desacct_entry.place(relx=0.039, rely=0.171, height=30, relwidth=0.411, bordermode='ignore')
        # self.desacct_entry.configure(background="white")
        # self.desacct_entry.configure(cursor="arrow")
        # self.desacct_entry.configure(disabledforeground="#a3a3a3")
        ...
        self.Label4.configure(
            text='''Ofoma Oluebube, Aderibigbe David, Akinyemi Hope, Adebiyi Alameen and  Chike Clinton''')
        ...
        self.Label5.configure(
            text='''We have locations somewhere around and we promise you can't be stranded. Check our locations below:''')
        ...
        self.accdetails.place(x=70, y=160, height=44, width=367
                              , bordermode='ignore')
        ...
        self.Delacc.place(x=70, y=360, height=44, width=367
                          , bordermode='ignore')
        ...
        self.ADmessage.place(x=140, y=40, height=43, width=260
                             , bordermode='ignore')
        ...
        self.depEntry2.place(x=166, y=159, height=27, width=204
                             , bordermode='ignore')
        ...
        self.depButton1.place(x=156, y=240, height=34, width=150
                              , bordermode='ignore')
        ...
        self.depButton10 = tk.Button(self.deposit, command=lambda: self.show_frame(self.adminframe))
        self.depButton10.place(x=381, y=29, height=34, width=77)
        self.depButton10.configure(activebackground="#ececec")
        self.depButton10.configure(activeforeground="#000000")
        self.depButton10.configure(background="#000000")
        self.depButton10.configure(borderwidth="1")
        self.depButton10.configure(disabledforeground="#a3a3a3")
        self.depButton10.configure(font="-family {Verdana} -size 9 -weight bold")
        self.depButton10.configure(foreground="#e8e800")
        self.depButton10.configure(highlightbackground="#d9d9d9")
        self.depButton10.configure(highlightcolor="black")
        self.depButton10.configure(pady="0")
        self.depButton10.configure(text='''Home''')
        ...
        self.delaccButton1.place(x=156, y=240, height=30, width=140
                                 , bordermode='ignore')
        ...
        self.checkaccLabel1.place(relx=0.073, rely=0.269, height=31, width=154
                                  , bordermode='ignore')
        ...
        self.checkaccEntry1.place(relx=0.382, rely=0.269, height=30
        ...
        self.checkaccb2.place(relx=0.382, rely=0.478, height=30, width=107
                              , bordermode='ignore')
        ...
        self.checkListbox1.place(relx=0.05, rely=0.066, relheight=0.84
                                 , relwidth=0.883)
